    ...
    <div>
      ...
      <div className="m-auto mb-8 flex max-w-[14rem] justify-center lg:mb-16">
        <div className="relative flex w-full rounded-full bg-white p-1 dark:bg-slate-900">
          ...
          <button
            className={`cursor-pointer relative h-8 flex-1 rounded-full text-sm font-medium transition-colors duration-150 ease-in-out focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 ${isAnnual ? "text-white" : "text-slate-500 dark:text-slate-400"}`}
          ...
          <button
            className={`cursor-pointer relative h-8 flex-1 rounded-full text-sm font-medium transition-colors duration-150 ease-in-out focus-visible:outline-none focus-visible:ring focus-visible:ring-indigo-300 dark:focus-visible:ring-slate-600 ${isAnnual ? "text-slate-500 dark:text-slate-400" : "text-white"}`}
      ...
      <div className="mx-auto grid max-w-sm items-start gap-6 lg:max-w-none lg:grid-cols-3 px-4">
        {/* Pricing tab 1 */}
        <PricingTab
          yearly={isAnnual}
          planName="Essential"
